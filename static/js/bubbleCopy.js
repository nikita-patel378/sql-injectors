...
var xScale = d3.scale.log().domain([0, 42000000]).range([0, width]),
    yScale = d3.scale.linear().domain([0, 4]).range([height, 0]),
    radiusScale = d3.scale.sqrt().domain([0, 520000]).range([0, 40]),
...
// Load the data.
d3.json("/bubble-data", function (nations) {
    ...
    function tweenYear() {
        var year = d3.interpolateNumber(1998, 2012);
